<x-app-layout>
    <div class="w-full grid grid-cols-4 gap-10">
            ...
            <div id="posts" class=" px-3 lg:px-7 py-6">
                <div class="flex justify-between items-center border-b border-gray-100">
                    <div id="filter-selector" class="flex items-center space-x-4 font-light ">
                        <button class="text-white py-4">Latest</button>
                        <button class="text-white py-4 border-b border-gray-700">Oldest</button>
                    </div>
                </div>
                <div class="py-4">
        ...
        <div id="side-bar"
            class="border-4 border-red-700 md:border-t-none col-span-4 md:col-span-1 px-3 md:px-6 space-y-10 py-6 pt-10 h-screen sticky top-0">
            <div id="search-box">
                <div>
                    ...
                    <div class="w-58 flex rounded-2xl bg-gray-100 py-1 px-3 mb-3 items-center">
                        ...
                        <input
                            class="w-40 ml-1 bg-transparent focus:outline-none focus:border-none focus:ring-0 outline-none border-none text-md text-gray-800 placeholder:text-gray-400"
